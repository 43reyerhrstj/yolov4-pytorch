...
from autils.dataloader import YoloDataset, yolo_dataset_collate
...
if __name__ == "__main__":
    ...
    #   权值文件请看README，百度网盘下载
    #------------------------------------------------------#
    model_path = "weight/yolo4_voc_weights.pth"
    ...
    if Cuda:
        ...
        # net = net.cuda()
        net = net.to(device)
        # 20210526  AssertionError: Torch not compiled with CUDA enabled
